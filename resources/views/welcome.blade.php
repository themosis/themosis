...
<div id="app">
    <div class="wrapper">
        <div class="head">
            ...
            <p>The Themosis framework is running.</p>
        </div>
        <div class="frame clearfix">
            <div id="get-started">
                <div class="container">
                    <h2>Get started:</h2>
                    <p>Check the documentation and build your next WordPress application.</p>
                    <a href="http://framework.themosis.com/docs/" target="_blank" title="Themosis framework documentation">View documentation</a>
                </div>
            </div>
            <div id="links">
                <div class="container">
